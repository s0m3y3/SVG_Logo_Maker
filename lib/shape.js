...
class Shapes {
  ...
  <text x="150" y="170" font-size="60" text-anchor="middle" fill="${this.text_color}">${this.text}</text>
  </svg>`;
...
class Circle extends Shapes {
  ...
  SVG = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="100" r="80" fill="${this.shape_color}" /><text x="150" y="170" font-size="60" text-anchor="middle" fill="${this.text_color}">${this.text}</text></svg>`;
}
...
function circle (text, textcolor,shapecolor){
  ...
  console.log("userCircle.SVG: "+ typeof userCircle.SVG)
  console.log(userCircle.SVG);
